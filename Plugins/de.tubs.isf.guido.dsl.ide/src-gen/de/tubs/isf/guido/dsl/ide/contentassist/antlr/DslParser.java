...
public class DslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getHypothesisAccess().getGroup_2_3(), "rule__Hypothesis__Group_2_3__0");
			...
			builder.put(grammarAccess.getDefinitionAccess().getGroup_10(), "rule__Definition__Group_10__0");
			builder.put(grammarAccess.getDefinitionAccess().getGroup_10_5(), "rule__Definition__Group_10_5__0");
			...
			builder.put(grammarAccess.getHypothesisAccess().getTypesAssignment_2_2(), "rule__Hypothesis__TypesAssignment_2_2");
			builder.put(grammarAccess.getHypothesisAccess().getTypesAssignment_2_3_1(), "rule__Hypothesis__TypesAssignment_2_3_1");
			...
			builder.put(grammarAccess.getDefinitionAccess().getParameterAAssignment_3(), "rule__Definition__ParameterAAssignment_3");
			builder.put(grammarAccess.getDefinitionAccess().getOptionsAAssignment_5(), "rule__Definition__OptionsAAssignment_5");
			builder.put(grammarAccess.getDefinitionAccess().getParameterAAssignment_6_1(), "rule__Definition__ParameterAAssignment_6_1");
			builder.put(grammarAccess.getDefinitionAccess().getOptionsAAssignment_6_3(), "rule__Definition__OptionsAAssignment_6_3");
			builder.put(grammarAccess.getDefinitionAccess().getPropertyAssignment_9(), "rule__Definition__PropertyAssignment_9");
			builder.put(grammarAccess.getDefinitionAccess().getParameterBAssignment_10_2(), "rule__Definition__ParameterBAssignment_10_2");
			builder.put(grammarAccess.getDefinitionAccess().getOptionsBAssignment_10_4(), "rule__Definition__OptionsBAssignment_10_4");
			builder.put(grammarAccess.getDefinitionAccess().getParameterBAssignment_10_5_1(), "rule__Definition__ParameterBAssignment_10_5_1");
			builder.put(grammarAccess.getDefinitionAccess().getOptionsBAssignment_10_5_3(), "rule__Definition__OptionsBAssignment_10_5_3");
