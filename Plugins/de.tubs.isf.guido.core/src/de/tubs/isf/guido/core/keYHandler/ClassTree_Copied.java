package de.tubs.isf.guido.core.keYHandler;
...
public class ClassTree_Copied extends JTree {
 ...
 public ClassTree_Copied(boolean addContractTargets, 
     ...
     public Component getTreeCellRendererComponent(JTree tree,
		...
		if(entry.target == null) {
			...
			((JLabel) result).setIcon(
					ClassTree_Copied.this.targetIcons.get(
